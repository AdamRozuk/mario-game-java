...
class Sprite {
	...
	public void draw(Graphics g) {
        ...
        public void nonalive()                        //co zrobić gdy okażę się, iz mario właśnie zginął (kolizja z ogniem )
        {
            try {
                this.alive=false;
                String x = "GO.png";
        ...
        public void win()       //analogicznie, co zrobic jeżeli wygralismy 
        {
            try {
                String x = "GO.png";
                String y = "win.jpg";
...
abstract class Mucha {              //a raczej nasze konfetti
...
class WektorMucha extends Mucha {
    ...
    protected void move() {    //jak ma sie poruszac dany typ muchy
...
class Szablonowa7 extends JPanel implements Runnable {
    ...
    public Szablonowa7(String nazwa) {              //łączenienie obrazu z obiektem much będącymi konfetti
...
class OrbitujacaMucha extends Mucha {
    ...
    protected void move() {             //w jaki sposób poruszać sie będzie drugi rodzaj muchy ( konffetti)
